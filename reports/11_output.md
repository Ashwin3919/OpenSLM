...
The following are raw generation outputs from 6 of the ~30M parameter architectures trained under the OpenSLM benchmark. 

All models were evaluated under identical constraints (TinyStories dataset, 20k steps, GPT-2 Tokenizer). Each generation was conditioned on the same prompt: `"Once upon a time"`.

---

## 1. GPT (Baseline)
> "Once upon a time, there was a little boy named Timmy. Timmy loved to play outside. One day, he found a big, shiny rock. He was very excited. He took it home to show his mom. 
> His mom said, "Wow, what a cool rock!" Timmy was so happy. They put the rock on a shelf to keep it safe. From that day on, Timmy and his mom always looked for shiny rocks together."

## 2. Jamba (Hybrid SSM-Attention)
...
> Lily being modest and rivers was so high that she could watch a bad joke during her day. The boy turned the noise and started to climb over it. She opened her book and saw how happy she was and ran away when the rainbow came out."
...
> But thenOnce there was a little boy called Jack. One day he was playing in the garden and he noticed something magical."
