...
# Embedding Block  (no wpe — RoPE handles position inside attention)
...
plt.tight_layout()
plt.savefig(out_dir / "llama_architecture.png", format='png', bbox_inches='tight', dpi=300)
plt.close()
print(f"  Saved → {out_dir / 'llama_architecture.png'}")
